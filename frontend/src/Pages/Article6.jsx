...
const Article6 = () => {
  ...
  const [currentSongIndex, setCurrentSongIndex] = useState(0);
    ...
    return (
      <div className="flex h-screen bg-gradient-to-b from-[#fde68a] via-[#fcd34d] to-[#f59e0b] text-black">
        ...
        <div className="flex-1 p-6 overflow-auto">
          ...
          <div className="flex justify-between items-center mb-4 flex-wrap gap-2">
            ...
            <div className="flex gap-2">
              <button
                className="bg-white p-2 rounded-full hover:bg-gray-600 transition"
                onClick={() => navigate("/article5")}
              >
                &lt;
              </button>
            ...
            <div className="flex items-center gap-2">
              ...
              <button className="bg-white px-4 py-2 rounded-md hover:bg-gray-600 transition">
                Install App
              </button>
            ...
            {["All", "Music", "Podcasts"].map((filter, index) => (
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-semibold ${
                  filter === "All" ? "bg-white text-black" : "bg-white"
          ...
          <div className="mt-6 flex flex-col md:flex-row gap-6 items-center">
            ...
            <div className="text-center md:text-left">
              ...
              <h2 className="text-4xl md:text-5xl font-bold">Mega Hit Mix</h2>
