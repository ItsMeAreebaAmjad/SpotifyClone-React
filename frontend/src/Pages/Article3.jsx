...
const Article3 = () => {
  ...
  const [currentSongIndex, setCurrentSongIndex] = useState(0);
    ...
    return (
      <div className="flex h-screen bg-gradient-to-b from-[#8b1a02] via-[#a32d10] to-[#c43d18] text-white">
        ...
        <div className="flex-1 p-6 overflow-auto">
          ...
          <div className="mt-6 flex flex-col md:flex-row gap-6 items-center">
            ...
            <div className="text-center md:text-left">
              ...
              <h2 className="text-4xl md:text-5xl font-bold">Top Songs India</h2>
